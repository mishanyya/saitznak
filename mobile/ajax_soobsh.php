...
$query="SELECT * FROM $userstable1 WHERE  otkogo='$login' AND komu='$login_q'  UNION SELECT * FROM $userstable1 WHERE otkogo='$login_q' AND komu='$login' ORDER BY nomer ASC limit $s,15";
