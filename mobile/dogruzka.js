...
echo.innerHTML = req.responseText; // показать ответ сервера
   ...
   req.open('GET', 'index14ajax.php?skakogo='+skakogo+'&dostroki='+dostroki+'&skolko='+skolko, true);  
...
if(skakogo==0){document.getElementById('button').style.display="none";}//когда строки кончаются кнопка убирается
...
//else{ chislo=10;}//по сколько записей выдает
 // chislo=parseInt(chislo, 10);//перевод из строки в число с основанием 10