...
$result = mysql_query("INSERT INTO $userstable (nomp,loginp,parp,vrepar,timeregistr,proveren,dengymone) VALUES (NULL,'$login','не задано', '$vremen',NOW(),'0','0')");

$result2 = mysql_query("INSERT INTO $userstable1 (loginp,imya,region,gorod,datarozd,vozrast,metkap,ipp,limitfoto,osebe,pol) VALUES ('$login','','','',CURDATE(),'0','2','','5','','')");//2-ГС
...
$moemail="admin@volgaplastic.16mb.com";
$send = mail ($address, $sub, $mes,'From:'.$moemail); 
