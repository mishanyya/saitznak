...
//require("sendmail.php"); подкючение к странице


$mhSmtpMail_Server = "smtp.domain.tld"; // smtp-сервер заменить на свои
$mhSmtpMail_Port = "25"; // порт smtp заменить на свои
$mhSmtpMail_Username = "postmaster@domain.tld"; // имя пользователя заменить на свои
$mhSmtpMail_Password = "password"; // пароль заменить на свои
